...
### 3.1 sendPaymentConfirmation
#### 3.1.1 Inputs/Outputs
- Declared signature: `sendPaymentConfirmation(String, String, BigDecimal)`
...
### 3.2 sendRefundConfirmation
#### 3.2.1 Inputs/Outputs
- Declared signature: `sendRefundConfirmation(String, String, BigDecimal)`
