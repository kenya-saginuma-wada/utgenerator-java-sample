...
|----------|--------|------|--------|------|
| [`charge(String, BigDecimal, String)`](#charge-string-bigdecimal-string) | Package-private | 1 | 1 (Low) | - |
| [`refund(String, BigDecimal)`](#refund-string-bigdecimal) | Package-private | 1 | 1 (Low) | - |
...
| Item | Value |
|------|------|
| Inputs | String customerId / BigDecimal amount / String paymentMethod |
...
### refund(String, BigDecimal)

**Summary**: Package-private / Parameters 2 / Calls 1
